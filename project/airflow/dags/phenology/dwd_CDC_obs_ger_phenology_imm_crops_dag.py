...
DESCRIPTION_DATA = 'PH_Beschreibung_Phasendefinition_Sofortmelder_Landwirtschaft_Kulturpflanze.txt'
FILENAME_BASE = 'PH_Sofortmelder_Landwirtschaft_Kulturpflanze'
ZIP_FILE_PATTERN = 'PH_Sofortmelder_Landwirtschaft_Kulturpflanze'
